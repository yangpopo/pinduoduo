    ...
    return <Fragment>
      {
        ...
        /* 默认-显示状态 */
        <div className={this.props.className === undefined ? "search-block-01" : this.props.className + " search-block-01"}>
          <div className="search-types-01">
            <div className="search-input-box" onClick={this.typesOpenChange}><svg className="icon-search" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="50124"><path d="M917.1 873.4L764.2 720.5c55.6-65.8 89-150.8 89-243.7 0-208.8-169.2-378-378-378s-378 169.2-378 378 169.2 378 378 378c92.9 0 177.9-33.5 243.7-89l152.9 152.9c6.2 6.2 14.4 9.4 22.6 9.4s16.4-3.1 22.6-9.4c12.6-12.6 12.6-32.8 0.1-45.3z m-441.8-82.6c-42.4 0-83.5-8.3-122.2-24.6-37.4-15.8-71-38.5-99.8-67.3-28.9-28.9-51.5-62.4-67.3-99.8-16.4-38.7-24.6-79.8-24.6-122.2s8.3-83.5 24.6-122.2c15.8-37.4 38.5-71 67.3-99.8 28.9-28.9 62.4-51.5 99.8-67.3 38.7-16.4 79.8-24.6 122.2-24.6s83.5 8.3 122.2 24.6c37.4 15.8 71 38.5 99.8 67.3 28.9 28.9 51.5 62.4 67.3 99.8 16.4 38.7 24.6 79.8 24.6 122.2s-8.3 83.5-24.6 122.2c-15.8 37.4-38.5 71-67.3 99.8-28.9 28.9-62.4 51.5-99.8 67.3-38.7 16.3-79.8 24.6-122.2 24.6z" p-id="50125"></path></svg>蓝牙耳机</div>
        ...
        :
        /* 搜索-显示状态 */
        <div className={this.props.className === undefined ? "search-block-02" : this.props.className + " search-block-02"}>
